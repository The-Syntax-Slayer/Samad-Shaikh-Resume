...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const handleCommand = (cmd) => {
        ...
        switch (base) {
            ...
            case "download":
                ...
                setTimeout(() => {
                    window.open("https://docs.google.com/document/d/1bIu_HW64GE8AmPA2uonXUi9kQt9aeeHpQDw53zJ9t18/export?format=pdf", "_blank");
                }, 500);
                break;
    ...
    const loadPDFViewer = () => {
        ...
        pdfIframe.src = "https://docs.google.com/document/d/1bIu_HW64GE8AmPA2uonXUi9kQt9aeeHpQDw53zJ9t18/preview";
